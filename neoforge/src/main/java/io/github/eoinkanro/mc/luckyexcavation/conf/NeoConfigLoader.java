...
public class NeoConfigLoader implements ConfigLoader {

  private final ModConfigSpec.Builder BUILDER = new ModConfigSpec.Builder();

  private final ModConfigSpec.IntValue DROP_CHANCE = BUILDER
  ...
  private final ModConfigSpec.IntValue DROP_CHANCE_MULTIPLAYER = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<Boolean> DROP_ENABLE_IN_CREATIVE = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<List<? extends String>> EXCAVATION_BLOCK_TAGS = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<List<? extends String>> EXCAVATION_BLOCK_NAMES = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<List<? extends String>> DROP_NAMES = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<String> LUCKY_MESSAGE = BUILDER
  ...
  private final ModConfigSpec.ConfigValue<Boolean> LUCKY_MESSAGE_ENABLE = BUILDER
